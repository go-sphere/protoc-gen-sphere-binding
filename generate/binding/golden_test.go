...
func goldenCases() []goldenCase {
	return []goldenCase{
		...
		{
			// Comprehensive cross-plugin fixture (OPT-02): the binding half of the
			// same shapes generated by protoc-gen-sphere's integration fixture -
			// FORM fields, well-known scalar wrappers bound as query, a uri/header
			// param, plus a nested message + map + oneof that must keep their json
			// tags.
			name:       "integration",
			pbFile:     "testdata/pb/integration.pb",
			protoName:  "integration.proto",
			inputFile:  "testdata/gen/integration.pb.go",
			wantChange: true,
			goldenFile: "testdata/golden/integration.pb.go",
		},
		{
